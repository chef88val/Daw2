...
use FloridaCampus\InfoBundle\Entity\Alumno;
use FloridaCampus\InfoBundle\Form\AlumnoType;
...
class AlumnoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $alumnos = $em->getRepository('InfoBundle:Alumno')->findAll();
    ...
    {
        $alumno = new Alumno();
        $form = $this->createForm('FloridaCampus\InfoBundle\Form\AlumnoType', $alumno);
    ...
    {
        $deleteForm = $this->createDeleteForm($alumno);
        $editForm = $this->createForm('FloridaCampus\InfoBundle\Form\AlumnoType', $alumno);
