...
<?php 
		...
		require 'functions.php';	//LLamará a las funciones que esten declaradas cuando estas se necesiten
...
?>
<input type="button" value="Terminar juego"  onClick="javascript:document.location.href='./logout.php'">      

	<div style="border: 1px solid black;margin: 1px;padding: 5px;margin-bottom: 20px;" class="userData ">
		Bienvenido <?= $jugador->getNombre()." ". $jugador->getApellidos() ." tienes "?>
		<?php 
		if (($jugador->getPuntos()=="")) {
		  ...
		  <?= ""." puntos" ;?>
 	<span style="float: right;"></span><span style="float: right;"><a href='jugador.php' >Perfil</a></span></div>
